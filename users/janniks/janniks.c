//------------------------------------------------------------------------------
// How to compile or flash different keyboards:
// $ .venv/bin/qmk compile -kb gboards/gergoplex -km janniks
// $ .venv/bin/qmk flash -kb ferris/sweep -km janniks
//------------------------------------------------------------------------------
...
[_BASE] = LAYOUT(
  ...
  MT(MOD_LSFT, KC_Z), KC_X,               KC_C,               KC_V,               KC_B,    KC_N, KC_M,               KC_COMM,               KC_DOT,               MT(MOD_RSFT, KC_SLSH),
                                           ...
                                           MT(MOD_LGUI, KC_SPC), LT(_SYM_LEFT, KC_TAB),    LT(_SYM_RIGHT, KC_ENT), KC_SPC
),
